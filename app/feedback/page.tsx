      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            <Link
              href="/"
              className="flex items-center justify-center w-14 h-14 mx-auto mb-4"
            >
              <Image
                src="/logo.png"
                alt="Tablium"
            ...
            <p className="text-base text-muted-foreground">
              Your opinion helps us improve My Outfit
            </p>
          </div>
          <div>
            <form
              action="https://formsubmit.co/contact@myout.fit"
              method="POST"
